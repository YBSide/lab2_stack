...
void tests() {
    ...
    auto test_human_input_1 = linked_list<struct human>(group, 3);
    auto test_human_input_2 = list_sequence<struct human>(&test_human_input_1);
    auto test_human_input_3 = stack<struct human>(&test_human_input_2);
    ...
    auto test_human_input_11 = linked_list<struct human>(for_concat_, 1);
    auto test_human_input_22 = list_sequence<struct human>(&test_human_input_11);
    auto test_human_input_33 = stack<struct human>(&test_human_input_22);
    ...
    auto test_function_input_1 = linked_list<int (*)()>(f, 3);
    auto test_function_input_2 = list_sequence<int (*)()>(&test_function_input_1);
    auto test_function_input_3 = stack<int (*)()>(&test_function_input_2);
    ...
    delete map_stack->items->items;
    delete map_stack->items;
    delete map_stack;
    delete where_stack->items->items;
    delete where_stack->items;
    delete where_stack;
    delete combined_stack->items->items;
    delete combined_stack->items;
    delete combined_stack;
    delete sub_stack->items->items;
    delete sub_stack->items;
    delete sub_stack;
}
